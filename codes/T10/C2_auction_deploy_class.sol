...
contract Auction {
    ...
    string public readme = "I will transfer 1000THB to the winner. If you win, please leave your bank info after the auction ends.";
    string public bankInfo;
    ...
    constructor() {
        ...
        endBlock = startBlock + 5; // change this to make the auction period shorter.  Eth block in a week = 50169
    ...
    function placeBid() public payable notOwner afterStart beforeEnd {
        ...
        require(
            ...
            "You need to send at least 0.1 ether."
        );
        require(
    ...
    function leaveBankInfo(string memory _bankInfo) public {
        require(block.number > endBlock, "Cannot leave the bank info, the auction is still ongoing.");
        require(auctionState != State.Cancelled, "Cannot leave the bank info, the auction is cancelled.");
        require(msg.sender == highestBidder, "You are not the winner. You cannot leave the bank information.");
        bankInfo = _bankInfo;
    }
}
